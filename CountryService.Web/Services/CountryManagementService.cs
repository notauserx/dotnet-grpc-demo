...
namespace CountryService.Web.Services
{
    public class CountryManagementService
    {
        ...
        public CountryManagementService()
        {
            _countries.Add(
                new CountryReply
                {
                    Id = 1,
                    Name = "Canada",
                    Description = "Has a lot of lakes",
            ...
            _countries.Add(
                new CountryReply
                {
                    Id = 1,
                    Name = "Mexico",
                    Description = "Siera Madre Oriental a n d siera Madre Occidental",
                    CreateDate = Timestamp.FromDateTime(DateTime.SpecifyKind(new DateTime(2021, 1, 2), DateTimeKind.Utc))
                });
        }
        ...
        public async Task<CountryReply> GetAsync(CountryIdRequest country) =>
            await Task.FromResult(_countries.FirstOrDefault(x => x.Id == country.Id));
